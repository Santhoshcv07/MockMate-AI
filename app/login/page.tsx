      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-12 lg:py-0 min-h-screen flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-[#666666] max-w-md leading-relaxed font-medium mb-10">
            Continue your interview preparation journey with MockMate AI.
          </p>
        ...
        {/* --- RIGHT SIDE: LOGIN CARD (ORDER 1 ON MOBILE, 2 ON DESKTOP) --- */}
        <motion.div 
          initial={{ opacity: 0, x: 30 }} 
          animate={{ opacity: 1, x: 0 }} 
        ...
        >
          ...
          <div className="w-full max-w-[440px] bg-white/75 backdrop-blur-xl border border-white/50 p-8 sm:p-12 rounded-[32px] shadow-[0_8px_30px_rgba(0,0,0,0.06)] relative z-10">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="pt-4">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  disabled={loading}
                  className="w-full h-[56px] rounded-[16px] bg-[#FF6B35] hover:bg-[#FF8C42] text-white font-black text-lg flex items-center justify-center shadow-[0_8px_20px_rgba(255,107,53,0.25)] disabled:opacity-70 disabled:cursor-not-allowed transition-colors"
                >
                  {loading ? (
            ...
            <p className="text-center text-[#666666] font-medium text-sm mt-8">
              ...
              <Link href="/signup" className="text-[#111111] font-bold hover:text-[#FF6B35] transition-colors underline underline-offset-4 decoration-2 decoration-gray-200 hover:decoration-[#FF6B35]">
                Create Account
              </Link>
            </p>
          </div>
